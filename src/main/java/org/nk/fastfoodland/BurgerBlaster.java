...
public class BurgerBlaster extends BowItem {

    public BurgerBlaster() {
        ...
        if (user instanceof PlayerEntity playerEntity) {
            ...
            if (!itemStack.isEmpty()) {
                ...
                if (!((double)f < 0.1)) {
                    ...
                    world.playSound((PlayerEntity)null, playerEntity.getX(), playerEntity.getY(), playerEntity.getZ(), SoundEvents.BLOCK_ANVIL_DESTROY, SoundCategory.PLAYERS, 1.0F, 1.0F / (world.getRandom().nextFloat() * 0.4F + 1.2F) + f * 0.5F);
    ...
    protected ProjectileEntity createArrowEntity(World world, LivingEntity shooter, ItemStack weaponStack, ItemStack projectileStack, boolean critical) {
        ...
        ArrowItem var10000;
        if (var8 instanceof Ketchup arrowItem) {
            var10000 = arrowItem;
        } else {
